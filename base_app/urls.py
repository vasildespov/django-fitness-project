...
urlpatterns = [
    ...
    path("features/blog/", BlogView.as_view(), name="blog"),
    path("features/blog/search-results/", SearchArticlesView.as_view(), name="search"),
    ...
    path(
        "profile/edit/change-password-success/",
        change_password_success,
        name="change password success",
    ),
    path(
        "profile/edit/change-username/",
        UserProfileEditView.as_view(),
        name="profile edit",
    ),
    path(
        "profile/edit/change-profile-picture/",
        UserProfilePicEditView.as_view(),
        name="profile pic edit",
    ),
    path("article/create/", CreateArticleView.as_view(), name="create article"),
    path(
        "article/details/<int:pk>-<slug:slug>/",
        ArticleDetailView.as_view(),
        name="article detail",
    ),
    path("article/like/<int:pk>/", like, name="like article"),
    path(
        "article/edit/<int:pk>-<slug:slug>/",
